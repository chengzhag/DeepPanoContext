...
function vis_line(p1, p2, color, lineWidth, lineStyle)
  if nargin < 3
    color = 'b';
  end
  ...
  switch numel(p1)
    case 2
      line([p1(1) p2(1)], [p1(2) p2(2)], 'Color', color, 'LineWidth', lineWidth, 'LineStyle', lineStyle);
    case 3
      line([p1(1) p2(1)], [p1(2) p2(2)], [p1(3) p2(3)], 'Color', color, 'LineWidth', lineWidth, 'LineStyle', lineStyle);
    otherwise
